'''
This program performs the learning for creating and using ZFNet models.
'''
...
RATIO = 5    # the undersampling ratio to use
...
def testNetwork(counties):
    ...
    with tf.Session(config=config) as sess:
        ...
        for county in counties:
            ...
            with open(RESULTS_FOLDER + "bestBalanced_county" + str(county) + "_" + ALGORITHM + "_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(PERCENT_ALL_FOR_TRAINING) + minMax + "_" + str(RANDOM_SEED) + ".csv", "w") as file:
                    #RESULTS_FOLDER + "bestBalanced_UNet_" + str(LAYERS) + "Layers_" + str(RANDOM_SEED) + ".csv", "w") as file:
                for wrongId in bestWrong:
                    file.write(wrongId + "\n")

            with open(RESULTS_FOLDER + "fewestWrong_county" + str(county) + "_" + ALGORITHM + "_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(PERCENT_ALL_FOR_TRAINING) + minMax + "_" + str(RANDOM_SEED) + ".csv", "w") as file:
                    #RESULTS_FOLDER + "fewestWrong_UNet_" + str(LAYERS) + "Layers_" + str(RANDOM_SEED) + ".csv", "w") as file:
                for wrongId in fewestWrong:
                    file.write(wrongId + "\n")

            with open(RESULTS_FOLDER + "results_county" + str(county) + "_" + ALGORITHM + "_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(PERCENT_ALL_FOR_TRAINING) + minMax + "_" + str(RANDOM_SEED) + ".csv", "w") as file:
            ...
            with open(RESULTS_FOLDER + "predictions_county" + str(county) + "_" + ALGORITHM + "_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(PERCENT_ALL_FOR_TRAINING) + minMax + "_" + str(RANDOM_SEED) + ".csv", "w") as file:
...
def tune(splitImages, splitLabels, splitIds):
    ...
    with tf.Session(config=config) as sess:
        ...
        with open(RESULTS_FOLDER + "bestBalanced_" + ALGORITHM + "TrainTest_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(RANDOM_SEED) + ".csv", "w") as file:
            for wrongId in bestWrong:
                file.write(wrongId + "\n")

        with open(RESULTS_FOLDER + "fewestWrong_" + ALGORITHM + "TrainTest_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(RANDOM_SEED) + ".csv", "w") as file:
            for wrongId in fewestWrong:
                file.write(wrongId + "\n")

        with open(RESULTS_FOLDER + "results_" + ALGORITHM + "TrainTest_" + str(RATIO) + "Ratio_" + str(LEARNING_RATE) + "LR_" + str(RANDOM_SEED) + ".csv", "w") as file:
            file.write("Limit,TP,FP,FN,TN,Acc,Recall_P,Precision_P,Recall_N,Precision_N,BalancedAcc,F1,MCC\n")
            for result in results:
                file.write(str(result[0]) + "," + ",".join(["{0:.6f}".format(num) for num in result[1:]]) + "\n")
